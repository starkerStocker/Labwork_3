...
<SwConfiguration CpuAddress="SL1" xmlns="http://br-automation.co.at/AS/SwConfiguration">
  ...
  <NcDataObjects>
    <NcDataObject Name="AcpParTab" Source="Libraries.AcpParTab.dob" Memory="UserROM" Language="Apt" />
  ...
  <Libraries>
    ...
    <LibraryObject Name="Acp10sim" Source="Acp10sim.lby" Memory="UserROM" Language="binary" Debugging="true" />
    <LibraryObject Name="Acp10_MC" Source="Acp10_MC.lby" Memory="UserROM" Language="binary" Debugging="true" />
    <LibraryObject Name="brsystem" Source="brsystem.lby" Memory="UserROM" Language="binary" Debugging="true" />
    <LibraryObject Name="AsIOTime" Source="AsIOTime.lby" Memory="UserROM" Language="binary" Debugging="true" />
